...
void main(void)
{
    ...
    _EINT();
	//TFT屏显示发送数据的标识
    sprintf(Send_Char,"Send Num:");
    etft_DisplayString(Send_Char,100,100,65535,0);   
	//TFT屏显示接收数据的标识
    sprintf(Recv_Char,"Recv Num:");
    etft_DisplayString(Recv_Char,100,140,65535,0);
